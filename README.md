# Olá, Mundo!
---
Este é o meu primeiro respositório do curso **Git e Github** do Professor *Gustavo Guanabara*.

O repositório foi criado como forma de aprendizagem para a utilização básica do git e github, e suas atribuições.
